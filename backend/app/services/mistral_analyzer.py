...
def _build_part_prompt(
    *,
    ...
    return (
        ...
        "ТОН объяснений — БЕЗЛИЧНЫЙ и по сути ошибки, а НЕ про автора:\n"
        "  • пиши «нарушен порядок слов…», «здесь нужен дательный падеж…», «окончание прилагательного неверное…»;\n"
        "  • НЕ пиши «автор хотел сказать…», «вы нарушили…», «студент сделал…» — не приписывай намерений и не обвиняй.\n"
        "  • описывай, ПОЧЕМУ в этом месте неверно (какое правило), а не кто что сделал.\n"
        ...
        "2) Пиши безлично и по сути: что именно неверно в этом месте и как записать правильно.\n"
