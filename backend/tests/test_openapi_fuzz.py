...
KNOWN_BUGS = (
    (
        "int too large",
        "Целое в пути больше int64 роняет драйвер БД → 500 вместо 404/422. "
        "Repro: curl -X POST http://localhost/api/essays/9223372036854775808/versions/1/restore "
        "Задевает все ручки с числовым параметром пути. "
        "Найдено Schemathesis 2026-07-26, заведено в PLANS.md.",
    ),
)
